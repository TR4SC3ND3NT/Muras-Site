  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="reveal mb-16 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="text-balance text-3xl font-semibold tracking-tight text-white md:text-5xl">
              One app.{" "}
              <span className="text-gradient-ember">Four sacred tools.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:gap-6">
          {features.map((f, idx) => {
            ...
            return (
              <article
                key={f.title}
                className="reveal group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035] p-7 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-white/20 md:p-9"
              >
                <div
                  ...
                  <div className="mb-2 flex items-baseline gap-3">
                    ...
                    <div
                      className={`h-px flex-1 bg-gradient-to-r ${
                        isEmber ? "from-ember/40" : "from-gold/40"
                      } to-transparent`}
                    />
                  </div>
